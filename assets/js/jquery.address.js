...
var addressInit = function (_cmbProvince, _cmbCity, _cmbArea, defaultProvince, defaultCity, defaultArea) {
    ...
    $("#" + _cmbProvince).attr("name", _cmbProvince);
    $("#" + _cmbCity).attr("name", _cmbCity);
    $("#" + _cmbArea).attr("name", _cmbArea);
    ...
    function changeCity() {
        ...
        if (cmbCity.selectedIndex == 0) {
            cmbAddOption(cmbArea, null, null);
            return;
        }
    ...
    function changeProvince() {
        ...
        if (cmbProvince.selectedIndex == 0) {
            cmbAddOption(cmbCity, null, null);
        }
        else {
    ...
    cmbAddOption(cmbProvince, null, null);
